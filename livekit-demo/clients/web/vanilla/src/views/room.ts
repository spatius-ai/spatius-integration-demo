 ...
 *
 * What differs is that there is nothing to send. Here the avatar is in the
...
export function createRoom(config: AppConfig): HTMLElement {
  ...
  root.innerHTML = `
    ...
    <div class="playground-center">
      <div class="center-header">
        <span class="avatar-count" data-name>LiveKit Demo</span>
      </div>
      <div class="canvas-stage">
        ...
        <!-- Nothing over the avatar here. The other two modes put pause and
             interrupt there because they drive playback; here the avatar is
  ...
  function renderPanel() {
    ...
    // on driving the avatar; here nothing is driven from this page — the
  ...
  function renderAll() {
    nameLabel.textContent = characterName || 'LiveKit Demo'
