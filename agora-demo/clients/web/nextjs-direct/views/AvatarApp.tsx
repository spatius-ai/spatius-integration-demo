...
/**
 * Straight into the room, in its own component so the page can defer the whole thing
 * with `next/dynamic` — see app/page.tsx for why the SDK cannot be imported into the
 * server pass.
 *
